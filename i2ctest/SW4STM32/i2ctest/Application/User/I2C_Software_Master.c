...
#define SCL_H         HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_SET)//GPIOB->BSRRL = GPIO_Pin_6
#define SCL_L         HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_RESET)//GPIOB->BSRRH = GPIO_Pin_6

#define SDA_H         HAL_GPIO_WritePin(GPIOB, GPIO_PIN_9, GPIO_PIN_SET)//GPIOB->BSRRL = GPIO_Pin_9
#define SDA_L         HAL_GPIO_WritePin(GPIOB, GPIO_PIN_9, GPIO_PIN_RESET)//GPIOB->BSRRH = GPIO_Pin_9
